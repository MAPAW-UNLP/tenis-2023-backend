 ...
 */
final class Version20231203004040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE horario_disponible (id INT AUTO_INCREMENT NOT NULL, fecha_ini DATE NOT NULL, fecha_fin DATE NOT NULL, hora_ini TIME NOT NULL, hora_fin TIME NOT NULL, profesor_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
